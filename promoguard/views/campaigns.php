...
<div class="head">
  <div>
    <h1>Campañas</h1>
    <p>Consulta qué campañas dejaron dinero, cuáles generaron pérdidas y cuáles conviene corregir.</p>
  </div>
...
<section>
  ...
  <div class="panel-head">
    <h2>Ejecutadas</h2>
    <span class="meta">comparadas con las ventas esperadas sin promoción</span>
  </div>
  <div class="table-wrap">
    <table>
      <thead><tr>
        ...
        <th class="num">Ventas extra</th><th class="num">Descuento recuperado</th><th class="num">Ganancia / pérdida</th>
      </tr></thead>
      <tbody>
    ...
    <div class="table-wrap">
      <table>
        <thead><tr>
          ...
          <th class="num">Descuento recuperado</th><th class="num">Ganancia / pérdida</th><th>Decisión</th><th></th>
        </tr></thead>
        <tbody>
        ...
        ?>
          <tr>
            ...
            <td class="num"><?= App::pct(min(1.0, $cov), 0) ?></td>
