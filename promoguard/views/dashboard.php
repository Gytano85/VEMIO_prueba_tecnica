...
<section class="headline">
  ...
  <div class="facts">
    <div class="fact">
      <div class="k">Superaron al escenario sin promoción</div>
...
<section class="value-strip" aria-label="Valor protegido por PromoGuard">
  ...
  <p>
    PromoGuard habría advertido este riesgo antes de aprobar las campañas. Esa cifra es margen
    que se dejó de perder, <b>no una ganancia ya obtenida</b>. El sistema además propone dos
    rutas que sí pueden dejar dinero: negociar aporte del proveedor y dirigir el incentivo a
    una parte de las unidades en lugar de subsidiarlas todas. Ninguna de las dos se puede
    medir con este histórico, porque aquí toda la venta de la ventana llevó descuento.
  </p>
    ...
    <table>
      <thead>
        <tr>
          ...
          <th class="num">Frente a no promocionar</th>
        </tr>
      </thead>
      <tbody>
