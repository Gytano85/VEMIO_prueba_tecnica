...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      paragraph("Para VEMIO cambia contra qué presupuesto compite. Un análisis se vende por proyecto y pelea contra cualquier consultora con un data scientist. El sistema se vende como suscripción y sale del mismo presupuesto que financia los descuentos: estos 6 SKUs entregaron $1,121,460 en 20 meses y por cada dólar sólo regresaron 38 centavos. Hubo una decisión cada 4.5 semanas; un catálogo de 200 SKUs al mismo ritmo son unas 380 al año, y un análisis trimestral no alcanza a tocarlas. Además el uso se reporta solo, así que la evidencia de renovación no hay que redactarla."),
      paragraph("Dos precisiones. El sistema evita pérdida, no genera ganancia, y la pantalla lo dice con esas palabras. Y el hallazgo probablemente no es exclusivo de este cliente: confundir un markup sobre costo con un margen sobre ingreso es un error contable, así que puede repetirse en el resto de la cartera."),
