...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      paragraph("Sobre qué prometer conviene distinguir dos cosas. Lo demostrado es margen que se deja de perder: con estos 6 SKUs ninguna profundidad de descuento abierto se paga sola, porque haría falta una elasticidad de entre 4.3 y 5.5 y las observadas van de 0.5 a 3.2. Lo que sí puede dejar dinero son las otras dos rutas que el sistema calcula: que el proveedor financie parte del descuento, y dirigir el incentivo a una parte de las unidades en lugar de subsidiarlas todas, ya que en este histórico el 100% de la venta de cada ventana llevó descuento, incluida la que se habría hecho igual. Ninguna se puede medir con este extracto porque nunca se probaron, y ambas requieren un piloto."),
