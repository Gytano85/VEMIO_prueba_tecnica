...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      paragraph("En términos absolutos 17 de las 19 promociones dejaron margen positivo: vendieron por encima del costo. Dos vendieron a pérdida. Ninguna superó lo que se habría ganado sin promocionar, o sea vendiendo menos unidades pero todas a precio de lista. La mejor, Combo Verano 2, recuperó 61 centavos por cada peso de margen sacrificado y la mediana del portafolio 37."),
      paragraph("Conviene situar el número: Nielsen ha medido que entre 59% y 75% de las promociones de consumo masivo no alcanzan el punto de equilibrio. Este portafolio cae en el extremo con 19 de 19, sea porque descuenta más agresivo que el promedio o porque el extracto, que el brief declara simulado, acentúa el fenómeno."),
      paragraph("Todo depende del contrafactual, así que medí su error: entre 6% y 10% de WAPE sobre las semanas sin promoción, con un sesgo de 0.3% a 0.8% que subestima la demanda y por tanto favorece a las promociones. Para que la mejor llegara al equilibrio tendría que estar sobreestimado en 39%. Lo verifiqué también sin modelo: con el uplift medido contra las semanas vecinas y el descuento real del extracto, el techo que cada campaña podía pagar sale de despejar d = u·m/((1+u)(1+m)), y ninguna quedó por debajo del suyo. Combo Verano 2 usó 16.1% cuando su uplift sólo pagaba 11.0%."),
      ...
      paragraph("El hallazgo tampoco parece exclusivo de este cliente: confundir un markup sobre costo con un margen sobre ingreso es un error contable, así que puede repetirse en el resto de la cartera."),
      paragraph("Conviene distinguir dos cosas al prometer. Lo demostrado es margen que se deja de perder: con estos 6 SKUs ningún descuento abierto se paga solo, porque haría falta una elasticidad de 4.3 a 5.5 y las observadas van de 0.5 a 3.2. Lo que sí puede dejar dinero son las otras dos rutas que el sistema calcula, aporte del proveedor y dirigir el incentivo a una parte de las unidades en vez de subsidiarlas todas, dado que aquí el 100% de la venta de cada ventana llevó descuento. Ninguna se puede medir con este extracto y ambas requieren un piloto."),
