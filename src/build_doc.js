...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      paragraph("Hay dos cosas que suelen confundirse y conviene separar. En absoluto, 17 de las 19 promociones dejaron margen positivo: vendieron por encima del costo. Sólo dos vendieron a pérdida. Pero ninguna superó lo que habría dejado vender ese mismo volumen a precio de lista. La mejor, Combo Verano 2, recuperó 61 centavos por cada peso de margen sacrificado; la mediana del portafolio recupera 37."),
      paragraph("La conclusión descansa entera en el contrafactual, así que la puse a prueba. El modelo tiene entre 6% y 10% de error sobre las semanas sin promoción y subestima la demanda entre 0.3% y 0.8%, o sea que si algo hace es favorecer a las promociones. Para que la mejor llegara al equilibrio, el contrafactual tendría que estar sobreestimado en 39%. Verifiqué además el margen por dos vías independientes y difieren menos de 1.5%. Con un grupo de bodegas sin promoción usaría eso como control en lugar del modelo."),
      ...
      paragraph("El análisis explica 19 promociones que ya ocurrieron y no impide la número 20. Por eso construí PromoGuard, una compuerta que valida el descuento contra el punto de equilibrio del producto antes de lanzar la promoción, calcula las ventas adicionales necesarias y bloquea las que venden bajo costo. Está publicada con los datos de este extracto: https://darkgrey-ram-842360.hostingersite.com"),
      paragraph("De los $699,241 de margen destruido, $96,106 los detiene una regla dura: dos promociones vendieron bajo costo y eso es aritmética, no criterio. Los otros $603,135 el sistema los marca antes de aprobar, y la decisión sigue siendo del equipo comercial. No eran casos al filo: 12 de esas 17 campañas estaban a menos de la mitad del umbral que necesitaban."),
      paragraph("Para VEMIO cambia contra qué presupuesto compite. Un análisis se vende por proyecto; el sistema se vende como suscripción y sale del mismo presupuesto que financia los descuentos, que en estos 6 SKUs fueron $1,121,460 en 20 meses con un retorno de 38 centavos por dólar. Hubo una decisión cada 4.5 semanas: con 200 SKUs al mismo ritmo son unas 380 al año, y un análisis trimestral no alcanza a tocarlas. El hallazgo tampoco parece exclusivo de este cliente: confundir markup con margen es un error contable, así que puede repetirse en el resto de la cartera. Eso sí, el sistema evita pérdida, no genera ganancia, y la pantalla lo dice con esas palabras."),
