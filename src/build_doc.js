...
const doc = new Document({
  ...
  sections:[{
    ...
    children:[
      ...
      P("Reproducibilidad: LightGBM se fija con deterministic, force_row_wise y n_jobs=1. Sin eso el ajuste depende del orden en que se construyen los histogramas y el WAPE se movia ~0.5 puntos entre ejecuciones, rompiendo la trazabilidad entre el notebook y las cifras de este documento.", {italics:true}),
      ...
      P("Se optó por un único modelo para los tres SKUs (11.2% de WAPE promedio) en vez de elegir el mejor por SKU sin información promocional (20.7%): es más preciso, más simple de operar, y evita sobreajustar la elección sobre sólo 5 observaciones de backtest."),
